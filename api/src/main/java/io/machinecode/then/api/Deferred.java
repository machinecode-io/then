 ...
 * @since 1.0
 */
public interface Deferred<T, F extends Throwable,P> extends OnResolve<T>, OnReject<F>, OnProgress<P>, Promise<T,F,P> {
    ...
    byte RESOLVED  = 1;
    /**
     * <p>This is a terminal state indicating {@link #reject(Throwable)} was the first terminal method called.</p>
     */
    byte REJECTED  = 2;
    /**
